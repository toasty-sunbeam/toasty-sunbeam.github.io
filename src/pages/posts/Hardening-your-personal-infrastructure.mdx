...
import vader from '/src/assets/posts/Hardening-your-personal-infrastructure/vader.png';
import lando from '/src/assets/posts/Hardening-your-personal-infrastructure/lando.jpg';
...
<Image class="meme" src={vader} alt='Darth Vader: "I am altering the deal. Pray I do not alter it any further."' />
...
<Image class="meme" src={lando} alt='Lando Calrissian: "This deal is getting worse all the time."' />
...
- [Unlimited file syncing](/posts/Hardened-file-syncing)
- [Your own password vault](/posts/Hardened-password-vault)
- [Cheap, effortless backups](/posts/Hardened-backups)
