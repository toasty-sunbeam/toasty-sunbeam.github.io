...
import passwordsMeme from '/src/assets/posts/Hardened-password-vault/passwords-meme.jpg';
import importCsv from '/src/assets/posts/Hardened-password-vault/import-csv.png';
import browserIntegration from '/src/assets/posts/Hardened-password-vault/browser-integration.png';
import connectFirefox from '/src/assets/posts/Hardened-password-vault/connect-firefox.png';
import firefoxSettings from '/src/assets/posts/Hardened-password-vault/firefox-settings.png';
import passwordGeneration from '/src/assets/posts/Hardened-password-vault/password-generation.png';
import banner from '/src/assets/posts/Hardened-password-vault/banner.png';
import login from '/src/assets/posts/Hardened-password-vault/login.png';
import toolbar from '/src/assets/posts/Hardened-password-vault/toolbar.png';
import newPassword from '/src/assets/posts/Hardened-password-vault/new-password.png';
import phoneKeyboard from '/src/assets/posts/Hardened-password-vault/phone-keyboard.jpg';
...
<Image class="meme" src={passwordsMeme} alt='She-Ra meme. Old and broken: Guessing passwords. New and cool: Stealing passwords.' />
...
<Image class="photo" src={importCsv} alt="KeePassXC's Import CSV Fields screen" />
...
<Image src={browserIntegration} alt="KeePassXC browser integration window" />
...
<Image src={connectFirefox} alt="Connecting the KeePassXC browser extension" />
...
<Image class="photo" src={firefoxSettings} alt="KeePassXC's browser extension" />
...
<Image class="photo" src={passwordGeneration} alt="Screenshot: signing up for a Discourse account" />
...
<Image src={banner} alt="KeePassXC browser extension banner" />
...
<Image src={login} alt="Logging into a website" />
...
<Image src={toolbar} alt="KeePassXC toolbar" />

<Image src={newPassword} alt="KeePassXC new password screen" />
...
<Image src={phoneKeyboard} alt="KeePassDX autofill" />
