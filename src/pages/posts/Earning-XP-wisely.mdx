...
import dellAsus from '/src/assets/posts/Earning-XP-wisely/The-Legend-of-Dell-and-Asus.png';
import pikachu from '/src/assets/posts/Earning-XP-wisely/Surprised_Pikachu.jpg';
import tshaped from '/src/assets/posts/Earning-XP-wisely/T-shaped-person.png';
...
<Image class="" src={dellAsus} alt="The Legend of Dell and Asus" />
...
<Image class="meme" src={pikachu} alt="Surprised Pikachu" />
...
<Image class="photo" src={tshaped} alt="Heavy Weapons Guy has many skills: hugeness, sandvich preparation, Über-charging, killing people, and Russian folk dancing. But there is one thing he is extremely good at, and that's heavy weaponry." />
