...
import line from '/src/assets/posts/Community-and-COVID-19/line.jpg';
import leftShelf from '/src/assets/posts/Community-and-COVID-19/left-shelf.jpg';
import rightShelf from '/src/assets/posts/Community-and-COVID-19/right-shelf.jpg';
import actOfLove from '/src/assets/posts/Community-and-COVID-19/the-act-of-love.jpg';
import mrRogers from '/src/assets/posts/Community-and-COVID-19/mr-rogers.jpg';
...
<Image class="photo" src={line} alt="A line of grocery carts stretching from the back of the store to the front" />
<Image class="photo" src={leftShelf} alt="A grocery aisle, barren of pasta" />
<Image class="photo" src={rightShelf} alt="Empty boxes of toilet paper" />
...
We see [artists processing fear into beauty](https://www.theguardian.com/artanddesign/2020/mar/18/the-act-of-love-using-photography-to-spread-unity-during-a-pandemic):

<Image class="photo" src={actOfLove} alt="A man and a woman wearing medical masks over their noses and mouths kiss tenderly." />
...
<Image class="photo" src={mrRogers} alt="When I was a boy and I would see scary things in the news, my mother would say to me, 'Look for the helpers. You will always find people who are helping.' --Fred Rogers" />
...
<div class="meme" style="width: max-content; box-shadow: none;">
