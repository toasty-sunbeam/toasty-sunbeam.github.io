...
import syncthingIcon from '/src/assets/posts/Hardened-file-syncing/Syncthing-icon.png';
import syncthingInterface from '/src/assets/posts/Hardened-file-syncing/Syncthing-interface.png';
...
<Image alt="Syncthing icon" src={syncthingIcon} width={100} />

Here's what the interface looks like:

<Image class="photo" src={syncthingInterface} alt='Screenshot of Syncthing' />
