...
import createBucket from '/src/assets/posts/Hardened-backups/create-a-bucket.png';
import appKeys from '/src/assets/posts/Hardened-backups/app-keys.png';
import addAppKey from '/src/assets/posts/Hardened-backups/add-app-key.png';
import newAppKey from '/src/assets/posts/Hardened-backups/new-app-key.png';
import duplicatiStep1 from '/src/assets/posts/Hardened-backups/duplicati-step-1.png';
import backupDestination from '/src/assets/posts/Hardened-backups/backup-destination.png';
import duplicatiStep2 from '/src/assets/posts/Hardened-backups/duplicati-step-2.png';
import duplicatiStep3 from '/src/assets/posts/Hardened-backups/duplicati-step-3.png';
import duplicatiStep4 from '/src/assets/posts/Hardened-backups/duplicati-step-4.png';
import duplicatiStep5 from '/src/assets/posts/Hardened-backups/duplicati-step-5.png';
import duplicatiJob from '/src/assets/posts/Hardened-backups/duplicati-job.png';
import duplicatiWarningsWebm from '/src/assets/posts/Hardened-backups/duplicati-warnings.webm';
import duplicatiWarningsPng from '/src/assets/posts/Hardened-backups/duplicati-warnings.png';
import duplicatiFiltersPng from '/src/assets/posts/Hardened-backups/duplicati-filters.png';
import duplicatiRestore from '/src/assets/posts/Hardened-backups/restore.webm';
...
<Image class="photo" src={createBucket} alt="Backblaze's 'Create a Bucket' screen" />
...
<a href={appKeys}>
	<Image class="photo" src={appKeys} alt="Backblaze's 'Application Keys' screen" />
</a>
...
<a href={addAppKey}>
	<Image class="photo" src={addAppKey} alt="Backblaze's 'Add Application Key' screen" />
</a>
...
<a href={newAppKey}>
	<Image class="photo" src={newAppKey} alt="Backblaze shows a new application key" />
</a>
...
<a href={duplicatiStep1}>
	<Image class="photo" src={duplicatiStep1} alt="Duplicati's 'General' screen" />
</a>
...
<a href={backupDestination}>
	<Image class="photo" src={backupDestination} alt="Set backup destination to Backblaze" />
</a>
...
<a href={duplicatiStep2}>
	<Image class="photo" src={duplicatiStep2} alt="Duplicati's 'backup destination' screen" />
</a>
...
<a href={duplicatiStep3}>
	<Image class="photo" src={duplicatiStep3} alt="Duplicati's 'source data' screen" />
</a>
...
<a href={duplicatiStep4}>
	<Image class="photo" src={duplicatiStep4} alt="Duplicati's 'schedule' screen" />
</a>
...
<a href={duplicatiStep5}>
	<Image class="photo" src={duplicatiStep5} alt="Duplicati's 'options' screen" />
</a>

When you're done, click Save. Your backup job is ready to run!

<a href={duplicatiJob}>
	<Image class="photo" src={duplicatiJob} alt="Duplicati's backup job, ready to run" />
</a>
...
<iframe width="700" height="600" class="mx-auto" src="https://www.youtube.com/embed/2ohjvXipdKM?si=nvmJWkDXMgazTp36" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<iframe width="700" height="600" class="mx-auto" src="https://www.youtube.com/embed/b0QNniZ9bx8?si=o0KoEI1F2FaBA6Jo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<a href={duplicatiFiltersPng}>
	<Image class="photo" src={duplicatiFiltersPng} alt="Setting up filters in Duplicati" />
</a>
...
<iframe width="700" height="600" class="mx-auto" src="https://www.youtube.com/embed/9YXVCbe0DFM?si=93Z_GHZmC8mmz5wc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
